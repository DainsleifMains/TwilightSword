...
pub struct NewPartnerFormAssociations {
	pub sessions: HashMap<String, NewPartnerFormAssociationData>,
}

#[derive(Debug)]
pub struct NewPartnerFormAssociationData {
...
pub fn new_partner_form_association_components(
	session_id: &str,
	form_list: &[Form],
